<%@ Page Language="C#" AutoEventWireup="true" CodeFile="连队申请被装.aspx.cs" Inherits="连队申请被装" %>
    ...
    <div>
        ...
        <asp:Panel ID="pannel" runat="server" Visible="False">
            <asp:GridView ID="GridView1" runat="server" Width="800px" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Pld" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
                ...
                <Columns>
                    <asp:BoundField DataField="被装名称" HeaderText="被装名称" SortExpression="Etype">
                    <ItemStyle HorizontalAlign="Center" />
                    <HeaderStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="被装型号" HeaderText="被装型号" />
                    <asp:BoundField DataField="性别" HeaderText="性别" ReadOnly="True" SortExpression="Pld">
                    <ItemStyle HorizontalAlign="Center" />
                    <HeaderStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="申请数量" HeaderText="申请数量" SortExpression="Pbaoguan">
                    <ItemStyle HorizontalAlign="Center" />
                    <HeaderStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="队别" HeaderText="队别" SortExpression="EName" >
                        <ItemStyle HorizontalAlign="Center" /> 
                        <HeaderStyle HorizontalAlign="Center"/>
                        </asp:BoundField>
                    <asp:BoundField DataField="申请状态" HeaderText="申请状态" SortExpression="PPersonuse" >
                        <ItemStyle HorizontalAlign="Center" /> 
                        <HeaderStyle HorizontalAlign="Center"/>
                        </asp:BoundField>
                </Columns>
