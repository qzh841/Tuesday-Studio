<%@ Page Language="C#" AutoEventWireup="true" CodeFile="仓库被装发放.aspx.cs" Inherits="设备报修" %>
...
<body>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server"  Width="1000px" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" style="margin-right: 0px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
